...
(function() {
  var exports, mkchart, renderfilejpg, renderfiletab, renderfiletabdou, run00, run01, run1, run2, run3, run3_1, socket, split_tab, split_tab_dou;
  ...
  renderfilejpg = function(file, container) {
    var resp;
    resp = {
      filename: file,
      type: 'jpg',
  ...
  socket.on('convertpdffinished', function(filename) {
    return alert("pdf file saved as " + filename);
  });
